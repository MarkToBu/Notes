...
dubbo
	com.etoak.service.UserService
	  providers
		dubbo://192.168.119.1:20880?		com.etoak.service.UserService

/dubbo/com.etoak.service.UserService/providers
1.zookeeper  服务端开启
2.生产者     将服务注册到zookeeper中
3.消费者     消费者获取zookeeper信息再去调用生产者
````

###   1.2   dubbo  架构

![dubbo-architucture](http://dubbo.apache.org/books/dubbo-user-book/sources/images/dubbo-architecture.jpg)
...
![dubbo-architucture-futures](http://dubbo.apache.org/books/dubbo-user-book/sources/images/dubbo-architecture-future.jpg)
